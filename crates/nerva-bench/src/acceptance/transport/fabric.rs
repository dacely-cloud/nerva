...
pub(crate) fn push_fabric_topology(report: &mut AcceptanceReport, runtime: &Runtime) {
    ...
    report.push(
        ...
        format!(
            "evidence={} gpu_pci={} gpu_root={} gpu_numa={} rdma_devices={} rdma_with_pci_path={} rdma_same_root={} rdma_same_numa={} iommu_groups={} iommu_mode={} rdma_core_loaded={} mlx5_core_loaded={} peer_memory_module={} dma_buf_export={:?} gpu_memory_export_verified={} cuda_vmm_posix_fd_export_verified={} cuda_gpu_direct_rdma_supported={:?} cuda_gpu_direct_rdma_with_vmm_supported={:?} gpu_direct_rdma={:?} pinned_host_staging={:?} gpu_direct_verified={} gpu_export_without_nic_direct={} degraded_to_pinned_host={} topology_affinity_known={} false_direct_claims={}",
            ...
            summary.dma_buf_export,
            summary.gpu_memory_export_verified,
            summary.cuda_vmm_posix_fd_export_verified,
            summary.cuda_gpu_direct_rdma_supported,
            summary.cuda_gpu_direct_rdma_with_vmm_supported,
...
pub(crate) fn push_fabric_backends(report: &mut AcceptanceReport, runtime: &Runtime) {
    ...
    report.push(
        ...
        matches!(summary.status, FabricBackendStatus::Ok)
            ...
            && summary.gpu_memory_export_verified
                == (summary.dma_buf_export == CapabilityState::SupportedAndVerified)
            && (!summary.gpu_export_without_nic_direct || summary.verified_direct_backends == 0)
