...
pub(crate) fn push_projection_benchmark(report: &mut AcceptanceReport) {
    ...
    report.push(
        ...
        summary.passed(),
        format!(
            "status={:?} rows={} cols={} dtype={} iterations={} cublaslt_avg_ns={} cublaslt_default_avg_ns={} cublaslt_heuristics={} cublaslt_best_heuristic_index={} cublaslt_best_heuristic_avg_ns={} custom_avg_ns={} selected_strategy={} cublaslt_bandwidth_bps={} custom_bandwidth_bps={} mismatches={} max_abs_diff={} device_allocations={} device_frees={} hot_path_allocations={} error={}",
            summary.status,
            summary.rows,
            summary.cols,
            summary.dtype,
