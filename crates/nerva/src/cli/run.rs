...
use nerva_runtime::engine::hf_cuda_decode::file_backed::generate::{
    HfCudaDeviceGenerateOutput, run_hf_causal_lm_cuda_shard_backed_device_generate_with_progress,
};
...
pub(crate) fn run_generate(args: &[String]) -> Result<GenerateResult, String> {
    ...
    let output = run_hf_causal_lm_cuda_shard_backed_device_generate_with_progress(
        &runtime,
        &model_path_string,
        &prompt_tokens,
        context_tokens,
    ...
    let chunks = output
        ...
        .map(|(index, chunk)| {
            ...
            let chunk_device_ns = chunk
                ...
                .sum::<u64>();
            format!(
                "{{\"chunk_index\":{},\"tokens\":{},\"wall_ns\":{},\"device_ns\":{},\"tokens_per_second\":{},\"projection_ns\":{},\"attention_ns\":{},\"mlp_ns\":{},\"norm_ns\":{},\"sampling_ns\":{},\"graph_nodes\":{},\"graph_replays\":{},\"graph_cache_hits\":{},\"kernel_launches\":{},\"h2d_bytes\":{},\"d2h_bytes\":{},\"sync_calls\":{},\"host_causality_edges\":{},\"hot_path_allocations\":{}}}",
                index,
                chunk.tokens.len(),
                chunk_wall_ns,
                chunk_device_ns,
        ...
        .join(",");
    Ok(format!(
        "{{\"status\":\"ok\",\"backend\":\"cuda\",\"mode\":\"generate\",\"nerva_version\":\"{}\",\"path\":\"{}\",\"input_mode\":\"{}\",\"prompt_mode\":\"{}\",\"prompt\":\"{}\",\"prompt_token_ids\":[{}],\"prompt_tokens\":{},\"max_new_tokens\":{},\"generated_tokens\":{},\"elapsed_wall_ns\":{},\"load_wall_ns\":{},\"prefill_wall_ns\":{},\"prefill_device_elapsed_ns\":{},\"decode_wall_ns\":{},\"post_load_wall_ns\":{},\"end_to_end_tokens_per_second\":{},\"post_load_tokens_per_second\":{},\"critical_path_wall_ns\":{},\"critical_path_device_ns\":{},\"critical_path_tokens_per_second\":{},\"tokens\":[{}],\"generated_text\":{},\"stop_reason\":\"{}\",\"hot_path_allocations\":{},\"chunks\":[{}],\"token_critical_paths\":[{}]}}",
