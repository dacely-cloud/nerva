...
fn synthetic_decode_summary_runs_1024_device_first_steps() {
    ...
    assert_eq!(summary.host_wait_events, 1);
    ...
    assert_eq!(summary.copy_latency_ns, 1);
    assert_eq!(summary.host_wait_latency_ns, 1);
    assert_eq!(summary.soft_visibility_sync_latency_ns, 1);
    assert_eq!(summary.estimated_events, 2050);
    assert_eq!(summary.estimated_latency_ns, summary.total_latency_ns);
    assert_eq!(summary.total_latency_ns, 4098);
