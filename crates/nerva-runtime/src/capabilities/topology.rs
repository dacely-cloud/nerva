...
pub fn discover_topology_snapshot() -> TopologySnapshot {
    ...
    TopologySnapshot {
        ...
        cxl_device_count: count_entries("/sys/bus/cxl/devices"),
        cxl_memory_device_count: count_prefixed_entries("/sys/bus/cxl/devices", "mem"),
        cxl_region_count: count_prefixed_entries("/sys/bus/cxl/devices", "region"),
