...
impl NativeCudaSources {
    pub(crate) fn new(manifest_dir: &Path) -> Self {
        ...
        let headers = vec![
            ...
            native_dir.join("hf_decode_sequence/deepseek/kernels_helpers_compression.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/kernels_helpers_kv_sparse.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/kernels_helpers_math.inc.cu"),
            ...
            native_dir.join("hf_decode_sequence/deepseek/kernels_sparse_moe_prefill.inc.cu"),
            ...
            native_dir.join("hf_decode_sequence/deepseek/kernels_v4_attention.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/kernels_v4_compression.inc.cu"),
            ...
            native_dir.join("hf_decode_sequence/deepseek/kernels_v4_swa_dense_layer.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/kernels_v4_swa_preproject.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/layout_plan.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/projection.cuh"),
            native_dir.join("hf_decode_sequence/deepseek/projection.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_api_snapshots.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_api_state.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_common_layout.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_common_runtime.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_decode.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_decode_common.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_decode_v3_projection.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_decode_v4_aux.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/session_decode_v4_projection.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/weights_pack.inc.cu"),
            native_dir.join("hf_decode_sequence/deepseek/weights_validation.inc.cu"),
