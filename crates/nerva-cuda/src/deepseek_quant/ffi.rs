...
#[repr(C)]
#[derive(Copy, Clone)]
pub(crate) struct NervaCudaDeepSeekQuantFp8F32ScaleEncodedGemmTokensRequest {
    pub(crate) rows: u32,
    pub(crate) cols: u32,
...
unsafe extern "C" {
    ...
    fn nerva_cuda_deepseek_quant_fp8_f32_scale_encoded_gemm_tokens(
...
pub(crate) fn run_deepseek_quant_fp8_f32_scale_encoded_gemm_tokens(
    request: &NervaCudaDeepSeekQuantFp8F32ScaleEncodedGemmTokensRequest,
    out: &mut NervaCudaDeepSeekQuantDequantResult,
) -> c_int {
