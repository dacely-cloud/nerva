...
pub struct CudaSmokeSummary {
    ...
    pub vmm_posix_fd_export_verified: Option<bool>,
...
impl CudaSmokeSummary {
    pub fn to_json(&self) -> String {
        ...
        format!(
            "{{\"status\":\"{}\",\"gpu_name\":{},\"driver_version\":{},\"runtime_version\":{},\"compute_capability_major\":{},\"compute_capability_minor\":{},\"posix_fd_handle_supported\":{},\"vmm_posix_fd_export_verified\":{},\"gpu_direct_rdma_supported\":{},\"gpu_direct_rdma_with_cuda_vmm_supported\":{},\"device_total_memory_bytes\":{},\"device_free_memory_bytes\":{},\"pci_bus_id\":{},\"device_arena_bytes\":{},\"pinned_host_bytes\":{},\"kernel_value\":{},\"hot_path_allocations\":{},\"error\":{}}}",
            status,
            ...
            json_opt_bool(self.vmm_posix_fd_export_verified),
    ...
    pub(crate) fn unavailable(error: impl Into<String>, runtime_version: Option<i32>) -> Self {
        Self {
            ...
            vmm_posix_fd_export_verified: None,
