...
fn null_layer() -> NervaCudaHfDecodeChainLayer {
    NervaCudaHfDecodeChainLayer {
        ...
        deepseek_rope_scaling_type: 0,
        deepseek_rope_original_max_position: 0,
        deepseek_rope_scaling_factor: 0.0,
        deepseek_rope_extrapolation_factor: 1.0,
        deepseek_rope_attn_factor: 1.0,
        deepseek_rope_beta_fast: 32.0,
        deepseek_rope_beta_slow: 1.0,
        deepseek_rope_mscale: 1.0,
        deepseek_rope_mscale_all_dim: 0.0,
        deepseek_compress_rope_theta: 0.0,
