...
pub(crate) struct NervaCudaProjectionBenchResult {
    ...
    pub(crate) cublaslt_graph_total_ns: u64,
    pub(crate) cublaslt_graph_avg_ns: u64,
    pub(crate) cublaslt_default_graph_total_ns: u64,
    pub(crate) cublaslt_default_graph_avg_ns: u64,
    pub(crate) cublaslt_best_heuristic_graph_total_ns: u64,
    pub(crate) cublaslt_best_heuristic_graph_avg_ns: u64,
    pub(crate) custom_graph_total_ns: u64,
    pub(crate) custom_graph_avg_ns: u64,
    pub(crate) cublaslt_graph_nodes: u64,
    pub(crate) custom_graph_nodes: u64,
    pub(crate) graph_replays: u64,
    pub(crate) graph_captures: u64,
    pub(crate) selected_graph_strategy: u32,
