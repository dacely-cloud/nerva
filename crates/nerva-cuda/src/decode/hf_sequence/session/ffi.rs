...
#[repr(C)]
#[derive(Copy, Clone)]
pub(crate) struct NervaCudaHfDecodeSequenceDeepSeekV4SwaKvSnapshotRequest {
    pub(crate) session: *mut NervaCudaHfDecodeSequenceSession,
...
#[repr(C)]
#[derive(Copy, Clone, Default)]
pub(crate) struct NervaCudaHfDecodeSequenceDeepSeekV4SwaKvSnapshotResult {
    pub(crate) status: i32,
    pub(crate) cuda_error: i32,
    pub(crate) layer_index: u32,
    pub(crate) block_count: u32,
    pub(crate) layer_offset_bytes: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub(crate) struct NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest {
    pub(crate) session: *mut NervaCudaHfDecodeSequenceSession,
    pub(crate) layer_index: u32,
    pub(crate) output_bytes: *mut u8,
    pub(crate) output_byte_capacity: u64,
...
#[repr(C)]
#[derive(Copy, Clone, Default)]
pub(crate) struct NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult {
    pub(crate) status: i32,
    pub(crate) cuda_error: i32,
    pub(crate) layer_index: u32,
    pub(crate) block_count: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub(crate) struct NervaCudaHfDecodeSequenceDeepSeekV4CompressedKvSnapshotRequest {
    pub(crate) session: *mut NervaCudaHfDecodeSequenceSession,
    pub(crate) layer_index: u32,
    pub(crate) output_bytes: *mut u8,
    pub(crate) output_byte_capacity: u64,
...
#[repr(C)]
#[derive(Copy, Clone, Default)]
pub(crate) struct NervaCudaHfDecodeSequenceDeepSeekV4CompressedKvSnapshotResult {
    pub(crate) status: i32,
    pub(crate) cuda_error: i32,
    pub(crate) layer_index: u32,
    pub(crate) block_count: u32,
...
unsafe extern "C" {
    ...
    fn nerva_cuda_hf_decode_sequence_deepseek_v4_swa_kv_snapshot(
        request: *const NervaCudaHfDecodeSequenceDeepSeekV4SwaKvSnapshotRequest,
        out: *mut NervaCudaHfDecodeSequenceDeepSeekV4SwaKvSnapshotResult,
    ) -> c_int;
    fn nerva_cuda_hf_decode_sequence_deepseek_v3_mla_kv_snapshot(
        request: *const NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest,
        out: *mut NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult,
    ) -> c_int;
    fn nerva_cuda_hf_decode_sequence_deepseek_v32_mla_packed_kv_snapshot(
        request: *const NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest,
        out: *mut NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult,
    ) -> c_int;
    fn nerva_cuda_hf_decode_sequence_deepseek_v32_indexer_kv_snapshot(
        request: *const NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest,
        out: *mut NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult,
    ) -> c_int;
    fn nerva_cuda_hf_decode_sequence_deepseek_v32_indexer_query_state_snapshot(
        request: *const NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest,
        out: *mut NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult,
    ) -> c_int;
    fn nerva_cuda_hf_decode_sequence_deepseek_v4_compressed_kv_snapshot(
...
pub(crate) fn snapshot_deepseek_v4_swa_kv(
    request: &NervaCudaHfDecodeSequenceDeepSeekV4SwaKvSnapshotRequest,
    out: &mut NervaCudaHfDecodeSequenceDeepSeekV4SwaKvSnapshotResult,
) -> c_int {
    unsafe { nerva_cuda_hf_decode_sequence_deepseek_v4_swa_kv_snapshot(request, out) }
}

pub(crate) fn snapshot_deepseek_v3_mla_kv(
    request: &NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest,
    out: &mut NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult,
) -> c_int {
    unsafe { nerva_cuda_hf_decode_sequence_deepseek_v3_mla_kv_snapshot(request, out) }
}

pub(crate) fn snapshot_deepseek_v32_mla_packed_kv(
    request: &NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest,
    out: &mut NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult,
) -> c_int {
    unsafe { nerva_cuda_hf_decode_sequence_deepseek_v32_mla_packed_kv_snapshot(request, out) }
}

pub(crate) fn snapshot_deepseek_v32_indexer_kv(
    request: &NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest,
    out: &mut NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult,
) -> c_int {
    unsafe { nerva_cuda_hf_decode_sequence_deepseek_v32_indexer_kv_snapshot(request, out) }
}

pub(crate) fn snapshot_deepseek_v32_indexer_query_state(
    request: &NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotRequest,
    out: &mut NervaCudaHfDecodeSequenceDeepSeekV3MlaKvSnapshotResult,
) -> c_int {
    unsafe { nerva_cuda_hf_decode_sequence_deepseek_v32_indexer_query_state_snapshot(request, out) }
}

pub(crate) fn snapshot_deepseek_v4_compressed_kv(
