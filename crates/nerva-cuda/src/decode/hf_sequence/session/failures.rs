...
pub(super) fn failed_run_summary(
    ...
    CudaHfDecodeSequenceSummary {
        ...
        resident_kv_bytes: 0,
        deepseek_mhc_residual_bytes: create.deepseek_mhc_residual_bytes,
        deepseek_mhc_post_mix_bytes: create.deepseek_mhc_post_mix_bytes,
        deepseek_mhc_comb_mix_bytes: create.deepseek_mhc_comb_mix_bytes,
        kv_tokens: 0,
        device_arena_bytes: 0,
        pinned_host_bytes: 0,
        h2d_bytes: 0,
