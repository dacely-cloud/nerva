...
pub struct CudaHfDecodeSequenceLayoutPlan {
    ...
    pub w_shared_expert_gate: u64,
    pub w_shared_expert_up: u64,
    pub w_shared_expert_down: u64,
...
impl From<NervaCudaHfDecodeSequenceLayoutPlanResult> for CudaHfDecodeSequenceLayoutPlan {
    fn from(value: NervaCudaHfDecodeSequenceLayoutPlanResult) -> Self {
        Self {
            ...
            w_shared_expert_gate: value.w_shared_expert_gate,
            w_shared_expert_up: value.w_shared_expert_up,
            w_shared_expert_down: value.w_shared_expert_down,
