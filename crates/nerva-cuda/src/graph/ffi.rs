...
pub(crate) struct NervaCudaSyntheticGraphResult {
...
pub(crate) fn run_synthetic_graph_smoke(
    steps: u32,
    ring_capacity: u32,
    seed_token: u32,
    out: &mut NervaCudaSyntheticGraphResult,
) -> c_int {
    unsafe { nerva_cuda_synthetic_graph_smoke(steps, ring_capacity, seed_token, out) }
}
