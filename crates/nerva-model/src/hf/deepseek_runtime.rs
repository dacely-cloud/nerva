...
pub fn deepseek_implemented_primitives(metadata: &HfModelMetadata) -> Vec<String> {
    ...
    let mut primitives = vec![
        ...
        "cuda_fp8_e4m3fn_e8m0_scale_encoded_gemm_tokens_tile16_weight_reuse".to_string(),
        "cuda_fp8_e4m3fn_e8m0_scale_encoded_gemm_tokens_row2_token16_input_reuse".to_string(),
