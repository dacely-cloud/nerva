...
#include "deepseek/kernels_prelude.inc.cu"
...
__global__ void hf_decode_sequence_kernel(
  ...
  rms_norm_with_weight_dtype(decoded, arena + arena_layout.final_norm, hidden,
                             final_norm_weight_dtype, dtype, rms_eps,
                             final_norm);
...
#include "deepseek/kernels_helpers.inc.cu"

#include "deepseek/kernels_v3_mla.inc.cu"
...
#include "deepseek/kernels_residual_norm.inc.cu"
...
#include "deepseek/kernels_v4_final_norm.inc.cu"
