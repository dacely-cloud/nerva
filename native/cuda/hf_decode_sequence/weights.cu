...
#include "deepseek/weights_validation.inc.cu"
...
#include "deepseek/weights_pack.inc.cu"
...
void pack_layer(SequenceLayerLayout &layout, uint64_t &cursor,
  ...
  initialize_deepseek_layout_metadata(layout, layer);
  ...
  initialize_deepseek_layout_offsets(layout);
