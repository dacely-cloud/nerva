struct NervaCudaHfDecodeSequenceSession {
  ...
  uint64_t kv_bytes = 0;
  uint64_t deepseek_v32_mla_kv_bytes = 0;
  uint64_t deepseek_swa_kv_bytes = 0;
  uint64_t deepseek_compressor_state_bytes = 0;
  ...
  uint64_t deepseek_sparse_topk_slots_bytes = 0;
  uint64_t deepseek_sparse_topk_count_bytes = 0;
  uint64_t deepseek_sparse_topk_scores_bytes = 0;
  uint64_t deepseek_mla_q_latent_bytes = 0;
  uint64_t deepseek_mla_attn_latent_bytes = 0;
  ...
  uint8_t *device_deepseek_v32_mla_kv = nullptr;
  uint8_t *device_deepseek_swa_kv = nullptr;
  float *device_deepseek_compressor_state = nullptr;
  ...
  int32_t *device_deepseek_sparse_topk_slots = nullptr;
  uint32_t *device_deepseek_sparse_topk_count = nullptr;
  float *device_deepseek_sparse_topk_scores = nullptr;
  uint16_t *device_deepseek_mla_q_latent = nullptr;
  uint16_t *device_deepseek_mla_attn_latent = nullptr;
