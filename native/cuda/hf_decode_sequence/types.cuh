...
constexpr uint32_t kDeepSeekRopeScalingNone = 0;
constexpr uint32_t kDeepSeekRopeScalingDeepSeek = 1;
...
constexpr uint32_t kDeepSeekStorageFp8Scaled = 0;
constexpr uint32_t kDeepSeekStorageBf16 = 1;
...
constexpr uint32_t kDeepSeekRuntimeCounterSparseTopkSelectionHash = 9;
constexpr uint32_t kDeepSeekRuntimeCounterV3GroupedRouterSelections = 10;
constexpr uint32_t kDeepSeekRuntimeCounterV4BiasRouterSelections = 11;
constexpr uint32_t kDeepSeekRuntimeCounterV4HashRouterSelections = 12;
constexpr uint32_t kDeepSeekRuntimeCounterRawAttentionTokensScanned = 13;
constexpr uint32_t kDeepSeekRuntimeCounterSparseAttentionOutputHash = 14;
constexpr uint32_t kDeepSeekRuntimeCounterCount = 15;
...
struct SequenceLayerLayout {
  ...
  uint32_t deepseek_rope_scaling_type;
  uint32_t deepseek_rope_original_max_position;
  float deepseek_rope_scaling_factor;
  float deepseek_rope_extrapolation_factor;
  float deepseek_rope_attn_factor;
  float deepseek_rope_beta_fast;
  float deepseek_rope_beta_slow;
  float deepseek_rope_mscale;
  float deepseek_rope_mscale_all_dim;
